...
<div class="card mt-2">
 <div class="row">
	<div class="col-lg-8 p-2 border-end">
		    <h4 class="header-title text-center">Lịch Khám bệnh của bạn</h4>
	          <div class="d-flex justify-content-center align-items-center app-search" >
                 ...
                 <!--   <div class="input-group" style="width: 30%">
	                  ...
	                  <div class="input-group ms-2" style="width: 40%">
	...
	<div class="col-lg-4 p-2">
		 <h4 class="header-title text-center">Danh sách bệnh nhân</h4>
	          <div class="d-flex justify-content-center align-items-center app-search" >
	             <!--      <input type="hidden" name="_token" value="MY8bTdAATR7NSq3bK5nxSYHvqDJehaRKg9hrghWA"> -->
...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  function load_history_schedule(key, value){
        ...
        $.ajax({
        url:"{{url('/doctor/load_history_schedule')}}",
        method:"GET",
         headers:{
...
///////////////////////////////////////////////////////////////////
  ...
  function load_list_patient(value){
      var _token = $('input[name="_token"]').val();
        $.ajax({
        url:"{{url('/doctor/load_list_patient')}}",
        method:"GET",
         headers:{
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
