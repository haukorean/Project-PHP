 ...
 <div class="card p-3 mt-2">
         ...
         <div class="row mt-1">
          ...
          <div class="col-sm-2 border-end">
        	    ...
        	    <div class="d-grid" id="load_schedule_today"> </div>
         	</div>
...
<div id="top-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="row">
               <h4 class="font-13 text-uppercase">BÁC SĨ   
                <span class="text-muted font-35 float-end" id="status_schedule"></span></h4>
                <div class="col-lg-4">
     ...
     <!--                 <button class="btn btn-primary btn-sm mt-1"><i class="uil uil-envelope-add me-1"></i>Chat</button>   -->    
                ...
                <div class="col-lg-8"><br>
                     <strong>Chuyên khoa:</strong><span class="ms-2" id="Specialis"></span><br>

                    <span class="text-muted mb-2 font-14 mt-1"><strong>SDT:</strong><span class="ms-2" id="phone_user"></span></span><br>

                    <span class="text-muted mb-2 font-14  mt-1">
                      <strong>Kinh nghiệm hành y :</strong> <span class="ms-2" id="work_experience"></span>
                      <strong>Giới tính :</strong> <span class="ms-2" id="sex_user"></span>
                    </span>
                     <p class="text-muted mb-2 font-14  mt-1"><strong>Địa chỉ:</strong><span class="ms-2" id="address"></span></p>
            ...
            <div class="modal-footer">
                 ...
                 <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="close_modal">DÓNG</button>
...
////////////////////////////////////////////////////////////////////////
  ...
  $(document).on('click','.btn_view_schudule',function(){
    ...
    function view_schedule_doctor(id){
        ...
        $.ajax({
        url:"{{url('/user/view_schedule_user')}}",
        method:"GET",
         headers:{
...
/////////////////////////////////////////////////////////////////////////////////////////////
   function load_schedule_date(date) {
    ...
    var _token = $('input[name="_token"]').val();
        ...
        $.ajax({
            url:"{{url('/user/load_schedule_date')}}",
            method:"get",
            // dataType:"JSON",
            headers:{
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
